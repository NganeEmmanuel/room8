...
/**
 * Unit tests for the {@link RefreshTokenService} class.
...
class RefreshTokenServiceTest {
    ...
    void testStoreRefreshToken() {
        // Act
        refreshTokenService.storeRefreshToken(email, refreshToken, expirationInMinutes);
    ...
    void testGetRefreshToken() {
        ...
        // Act
        String retrievedToken = refreshTokenService.getRefreshToken(email);
