...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NoBidFoundException.class)
    public ResponseEntity<String> handleNoBidFoundException(NoBidFoundException ex, WebRequest request) {
        logger.error("Error occurred: {}", ex.getMessage(), ex);
        return new ResponseEntity<>("No bid found", HttpStatus.NOT_FOUND);
    }
